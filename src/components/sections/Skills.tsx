...
import {
  FaReact, FaJava, FaPython, FaNodeJs, FaDocker,
  FaGitAlt, FaAws, FaDatabase, FaCloud
} from 'react-icons/fa';
import {
  SiTypescript, SiJavascript, SiSpringboot, SiPostgresql,
  SiKubernetes, SiTailwindcss
} from 'react-icons/si';
...
export default function Skills() {
  ...
  const skillCategories = [
    { titleKey: skillsMessages.categoryPrimarySkills, skills: PROFILE_DATA.skills.primary, icon: <FaReact className="text-[#34d399]" /> },
    { titleKey: skillsMessages.categoryLanguages, skills: PROFILE_DATA.skills.languages, icon: <SiJavascript className="text-[#ec4899]" /> },
    { titleKey: skillsMessages.categoryFrontend, skills: PROFILE_DATA.skills.frontend, icon: <SiTailwindcss className="text-[#a855f7]" /> },
    { titleKey: skillsMessages.categoryBackend, skills: PROFILE_DATA.skills.backend, icon: <FaNodeJs className="text-[#34d399]" /> },
    { titleKey: skillsMessages.categoryDatabases, skills: PROFILE_DATA.skills.databases, icon: <FaDatabase className="text-[#ec4899]" /> },
    { titleKey: skillsMessages.categoryDevops, skills: PROFILE_DATA.skills.devops, icon: <FaDocker className="text-[#a855f7]" /> },
    { titleKey: skillsMessages.categoryCloud, skills: PROFILE_DATA.skills.cloud, icon: <FaAws className="text-[#34d399]" /> },
    { titleKey: skillsMessages.categoryOther, skills: PROFILE_DATA.skills.other, icon: <FaCloud className="text-[#ec4899]" /> },
  ];
  return (
    <section 
      id="skills" 
